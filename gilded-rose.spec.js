...
import { Item, items, BasicItem, CheeseItem, LegendaryItem, ConcertItem, ConjuredItem } from "./gilded-rose.js";
...
describe("updateQuality", () => {
  ...
  it("degrades quality by 2 when sellIn < 0", () => {
    const testItem = new BasicItem("basic", -1, 5);
    items.push(testItem);
  ...
  it("aged brie quality increases by 1", () => {
    const testItem = new CheeseItem("Aged Brie", 5, 5);
    items.push(testItem);
  ...
  it("never increases quality geater than 50", () => {
    const testItem = new CheeseItem("Aged Brie", 5, 50);
    items.push(testItem);
  ...
  it("increases quality when sellIn > 10 before TAFKAL80ETC concert", () => {
    const testItem = new ConcertItem("Backstage passes to a TAFKAL80ETC concert", 15, 20);
    items.push(testItem);
    ...
    it("deccreases the quality of Conjured items by 2", () => {
